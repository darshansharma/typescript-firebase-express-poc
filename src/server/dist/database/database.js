...
var Database = /** @class */ (function () {
    ...
    Database.prototype.storeUserDetails = function (uid, name, email) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, docRef.doc(uid).set(user)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Database.prototype.getUserDetails = function (uid) {
        return __awaiter(this, void 0, void 0, function () {
            var userDoc, user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        userDoc = this.db.collection('user').doc(uid);
